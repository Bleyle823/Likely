...
` + userPrompt + question }]
  ...
  const body = Buffer2.from(new TextEncoder().encode(bodyJson)).toString("base64");
  const model = runtime2.config.geminiModel.trim();
  ...
  let finalResponse = runtime2.runInNodeMode((nodeRuntime) => {
