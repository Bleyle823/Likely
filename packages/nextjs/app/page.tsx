      ...
      <div className="flex items-center flex-col grow pt-10">
        <div className="px-5">
          ...
          <p className="text-center text-lg mt-6 max-w-2xl mx-auto text-base-content/80">
            Trade on the outcome of future events powered by{" "}
            <span className="font-bold text-primary">Google Gemini AI</span> and{" "}
            <span className="font-bold text-secondary">Chainlink CRE</span>
          </p>
